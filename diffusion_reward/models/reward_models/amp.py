...
class Discriminator(nn.Module):
    def __init__(self, args):
        ...
        self.trunk = nn.Sequential(
            nn.Linear(self.repr_dim, args.hidden_dim),
            nn.Tanh(),
    ...
    def compute_grad_pen(self, expert_state, policy_state, lambda_=0.1):
        ...
        grad = autograd.grad(
            outputs=disc, inputs=mixup_data, grad_outputs=ones, create_graph=True, retain_graph=True, only_inputs=True
        )[0]
