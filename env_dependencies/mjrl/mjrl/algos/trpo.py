...
class TRPO(NPG):
    ...
    def train_from_paths(self, paths):
        ...
        self.running_score = (
            mean_return if self.running_score is None else 0.9 * self.running_score + 0.1 * mean_return
        ...
        for k in range(100):
            ...
            if kl_dist < self.kl_dist:
                ...
                print(
                    "Step size too high. Backtracking. | kl = %f | surr diff = %f" % (kl_dist, surr_after - surr_before)
                )
            if k == 99:
                alpha = 0.0
