...
from diffusion_reward.rl.drqv2.replay_buffer import AMPBuffer, ReplayBufferStorage, ReplayCache, make_replay_loader
...
class Workspace:
    def __init__(self, cfg):
        ...
        if self.cfg.use_wandb:
            ...
            wandb.init(project=proj_name, group=group_name, name=exp_name, config=cfg)
        ...
        self.setup()
        self.agent = make_agent(self.train_env.observation_spec(), self.train_env.action_spec(), self.cfg.agent)
    ...
    def setup(self):
        ...
        # create envs
        self.train_env = make_env(self.cfg.task_name, self.cfg.frame_stack, self.cfg.action_repeat, self.cfg.seed)
        self.eval_env = make_env(self.cfg.task_name, self.cfg.frame_stack, self.cfg.action_repeat, self.cfg.seed)
